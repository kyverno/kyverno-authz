...
## TargetMatchConstraints     {#policies-kyverno-io-v1alpha1-TargetMatchConstraints}
...
| `MatchResources` | [`admissionregistration/v1.MatchResources`](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#matchresources-v1-admissionregistration) |  | :white_check_mark: | <p>TargetMatchConstraints specifies what target mutation resources this policy is designed to evaluate.</p> |
