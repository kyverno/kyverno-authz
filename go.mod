module github.com/kyverno/kyverno-authz
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20251113035405-7471efdf9871
	github.com/hairyhenderson/go-fsimpl v0.3.1
	github.com/kyverno/kyverno v1.16.1-rc.2
...
require (
	...
	github.com/aptible/supercronic v0.2.36 // indirect
