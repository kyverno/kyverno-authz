	...
	libraryDecls := map[string][]cel.FunctionOpt{
		...
		"GetIntArgument": {
			cel.MemberOverload("mcp_get_int",
				[]*cel.Type{MCPRequestType, types.StringType, types.IntType},
				types.IntType,
		...
		"GetFloatArgument": {
			cel.MemberOverload("mcp_get_float",
				[]*cel.Type{MCPRequestType, types.StringType, types.DoubleType},
				types.DoubleType,
		...
		"GetBoolArgument": {
			cel.MemberOverload("mcp_get_bool",
				[]*cel.Type{MCPRequestType, types.StringType, types.BoolType},
				types.BoolType,
		...
		"GetStringSliceArgument": {
			cel.MemberOverload("mcp_get_string_slice",
				[]*cel.Type{MCPRequestType, types.StringType, cel.ListType(types.StringType)},
		...
		"GetIntSliceArgument": {
			cel.MemberOverload("mcp_get_int_slice",
				[]*cel.Type{MCPRequestType, types.StringType, cel.ListType(types.IntType)},
		...
		"GetFloatSliceArgument": {
			cel.MemberOverload("mcp_get_float_slice",
				[]*cel.Type{MCPRequestType, types.StringType, cel.ListType(types.DoubleType)},
		...
		"GetBoolSliceArgument": {
			cel.MemberOverload("mcp_get_bool_slice",
				[]*cel.Type{MCPRequestType, types.StringType, cel.ListType(types.BoolType)},
